...
public class NearbyFacilityTest {
  ...
  private NearbyFacility.Nearby nearbyFacility(
      String facilityId, Integer minTime, Integer maxTime, String related) {
    return NearbyFacility.Nearby.builder()
        .id(facilityId)
        .type(NearbyFacility.Type.NearbyFacility)
        .attributes(NearbyFacility.Attributes.builder().minTime(minTime).maxTime(maxTime).build())
        .relationships(
            NearbyFacility.Relationships.builder()
                .vaFacility(
                    NearbyFacility.VaFacility.builder()
                        .links(NearbyFacility.Links.builder().related(related).build())
                        .build())
                .build())
        .build();
  }
    ...
    return NearbyFacility.builder()
        .links(
            PageLinks.builder()
                ...
                .build())
        .meta(
            NearbyFacility.Metadata.builder()
                .pagination(
                    Pagination.builder()
                        .currentPage(1)
                        .entriesPerPage(20)
