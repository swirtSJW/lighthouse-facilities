...
public final class SerializerUtil {
  ...
  static SimpleModule serializersV1() {
    ...
    mod.addSerializer(GeoFacility.class, new GeoFacilitySerializer());
    mod.addSerializer(Geometry.class, new GeometrySerializer());
    mod.addSerializer(Properties.class, new PropertiesSerializer());
    ...
    mod.addSerializer(GeoFacilitiesResponse.class, new GeoFacilitiesResponseSerializer());
    mod.addSerializer(GeoFacilityReadResponse.class, new GeoFacilityReadResponseSerializer());
