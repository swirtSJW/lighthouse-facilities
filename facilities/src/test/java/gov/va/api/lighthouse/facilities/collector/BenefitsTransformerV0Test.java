...
public class BenefitsTransformerV0Test {
  ...
  private BenefitsTransformerV0 tx() {
    return tx(null);
  }

  private BenefitsTransformerV0 tx(String csvWebsite) {
    return BenefitsTransformerV0.builder()
