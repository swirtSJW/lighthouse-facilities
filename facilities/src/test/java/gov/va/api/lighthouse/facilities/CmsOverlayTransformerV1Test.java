    ...
    return DatamartCmsOverlay.builder()
        .operatingStatus(
            DatamartFacility.OperatingStatus.builder()
                ...
                .build())
        .detailedServices(
            healthServices != null ? getDatamartDetailedServices(healthServices) : null)
        .build();
  }
        ...
        .map(
            hs -> {
              return DatamartDetailedService.builder()
                  .active(true)
                  .name(
                      hs.name().equals(DatamartFacility.HealthService.Covid19Vaccine.name())
                          ? "COVID-19 vaccines"
                          : hs.name())
        ...
        .map(
            hs -> {
              return DetailedService.builder()
                  .active(true)
                  .name(
                      hs.name().equals(Facility.HealthService.Covid19Vaccine.name())
                          ? "COVID-19 vaccines"
                          : hs.name())
                  .serviceId(uncapitalize(hs.name()))
                  .path("https://path/to/service/goodness")
    ...
    return CmsOverlay.builder()
        .operatingStatus(
            Facility.OperatingStatus.builder()
                ...
                .additionalInfo("additional operating status info")
                .build())
        .detailedServices(healthServices != null ? getDetailedServices(healthServices) : null)
        .build();
  }
