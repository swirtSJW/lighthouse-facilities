...
public class StateCemeteryTransformerV0Test {
  @Test
  void asAddress_parseLine1() {
    assertThat(StateCemeteryTransformerV0.asAddress("AL", "Spanish Fort, AL, 36577-1234", "", ""))
        .isEqualTo(
            Facility.Address.builder().zip("36577-1234").city("Spanish Fort").state("AL").build());

    assertThat(StateCemeteryTransformerV0.asAddress("AL", "blah", "", ""))
        .isEqualTo(Facility.Address.builder().address1("blah").build());

    assertThat(StateCemeteryTransformerV0.asAddress("AL", "", "", "")).isNull();
  }

  @Test
  void asAddress_parseLine2() {
    assertThat(
            StateCemeteryTransformerV0.asAddress(
    ...
    assertThat(StateCemeteryTransformerV0.asAddress("AL", "34904 State Highway 225", "blah", ""))
        .isEqualTo(
            Facility.Address.builder().state("AL").address1("34904 State Highway 225").build());

    assertThat(StateCemeteryTransformerV0.asAddress("AL", "", "blah", "")).isNull();
  }
    ...
    assertThat(
        ...
        .isEqualTo(
            Facility.Address.builder()
                ...
                .build());
    assertThat(
            StateCemeteryTransformerV0.asAddress("AL", "34904 State Highway 225", "blah", "blah"))
        .isEqualTo(
            Facility.Address.builder()
                .state("AL")
                .address1("34904 State Highway 225")
                .address2("blah")
                .build());
    assertThat(StateCemeteryTransformerV0.asAddress("AL", "blah", "blah", "blah"))
        .isEqualTo(
