...
import gov.va.api.lighthouse.facilities.CmsOverlayHelperV1;
...
public class CmsOverlayCollectorV1 {
                ...
                if (containsCovidService(detailedServices)) {
                  cmsOverlayRepository.save(
                      CmsOverlayEntity.builder()
                          ...
                          .cmsOperatingStatus(
                              CmsOverlayHelperV1.serializeOperatingStatus(
                                  MAPPER_V1, operatingStatus))
                          .cmsServices(
                              CmsOverlayHelperV1.serializeDetailedServices(
                                  MAPPER_V1, detailedServices))
                          .build());
                  log.info(
